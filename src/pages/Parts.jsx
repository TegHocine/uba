  ...
  return (
    <div className='w-3/4 md:w-2/3 mx-auto p-12'>
      ...
      <div className='relative overflow-x-auto pt-5'>
        ...
        <button className=' fixed bottom-10 right-10 p-0 w-14 h-14 bg-teal-600 rounded-full hover:bg-teal-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none'>
          <svg
            viewBox='0 0 20 20'
